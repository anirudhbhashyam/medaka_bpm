...
class IOHandler:
    def __init__(self, out_dir: str) -> None:
        ...
        self.results_dir = os.path.join(self.out_dir, "qc_analysis_results_training")
    ...
    def write_figs(self, plots: Plot) -> None:
        write_dir = self._create_dir("figs")
        self._write(plots, write_dir)
